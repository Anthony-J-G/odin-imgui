...
import implot "../_build/dist/implot"
...
main :: proc() {
    ...
    defer implot.destroy_context(nil)
    ...
    for !glfw.WindowShouldClose(window) {
        ...
        imgui.new_frame()
        {
            ...
            if implot.begin_plot("My Plot") {                
                defer implot.end_plot()                

                // implot.plot_bars("My Bar Plot", bar_data, 11);
                // implot.plot_line("My Line Plot", x_data, y_data, 1000);            
